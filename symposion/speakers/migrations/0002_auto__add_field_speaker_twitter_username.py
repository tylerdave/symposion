...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Speaker.twitter_username'
        db.add_column(u'speakers_speaker', 'twitter_username',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Speaker.twitter_username'
        db.delete_column(u'speakers_speaker', 'twitter_username')
